...
ALTER TABLE [Versions] ADD DEFAULT '' FOR [Identifier];
GO
...
ALTER TABLE [VersionGroups] ADD DEFAULT '' FOR [Identifier];
GO
...
ALTER TABLE [Region] ALTER COLUMN [Identifier] varchar(50) NOT NULL;
ALTER TABLE [Region] ADD DEFAULT '' FOR [Identifier];
GO
...
ALTER TABLE [Languages] ADD DEFAULT '' FOR [Identifier];
GO
...
ALTER TABLE [Generations] ADD DEFAULT '' FOR [Identifier];
GO
