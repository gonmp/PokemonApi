...
ALTER TABLE [Versions] ALTER COLUMN [Identifier] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [VersionNames] ALTER COLUMN [Name] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [VersionGroups] ALTER COLUMN [Identifier] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [Regions] ALTER COLUMN [Identifier] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [RegionNames] ALTER COLUMN [Name] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [Languages] ALTER COLUMN [Identifier] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [LanguageNames] ALTER COLUMN [Name] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [Generations] ALTER COLUMN [Identifier] nvarchar(50) NOT NULL;
GO
...
ALTER TABLE [GenerationNames] ALTER COLUMN [Name] nvarchar(50) NOT NULL;
GO
